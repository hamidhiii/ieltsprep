            ...
            >
                <div className="bg-white p-8 sm:p-10 rounded-[32px] border border-gray-100 shadow-xl overflow-hidden relative">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-gray-500 text-center mt-2">Sign in to access your IELTS practice dashboard.</p>
                    </div>
                    ...
                    <p className="text-center text-gray-500 mt-8 text-sm">
                        Don't have an account? <Link to="/signup" className="text-primary font-bold hover:text-primary-dark">Create Account</Link>
                    </p>
                </div>
            </motion.div>
        </main>
